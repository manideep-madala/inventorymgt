...
public class InventoryUi {
	...
	private void runapp() {
		try {
			...
			list.add(item1);
			Item item2=new Item("headphones",supplier1);
			list.add(item2);
			Item item3=new Item("speakers",supplier1);
			list.add(item3);
			Computer item4=new Computer("hpelitebook",supplier2,5000);
			list.add(item4);
			Phone item5=new Phone("nokia",supplier2,2000);
			list.add(item5);
			service2.add(item1);
			service2.add(item2);
			service2.add(item3);
